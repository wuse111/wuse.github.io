...
def get_font():
    ...
    # TTFont()  用来打开woff文件的
    #通过在网页读取woff数据，保存读取的woff数据
    movie_font = TTFont('2850eeb5.woff')
    ...
    base_font = ['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '店', '中', '美', '家', '馆', '小', '车', '大', '市', '公',
                 ...
                 '糕']
    base_uniname = movie_font['cmap'].tables[0].ttFont.getGlyphOrder()[2:]
...
if __name__ == '__main__':
    ...
    # uniea9a  xea9a
    base_font = get_font()
    string = '网上<svgmtsi class="review">&#xf494;</svgmtsi><svgmtsi class="review">&#xec12;</svgmtsi><svgmtsi class="review">&#xe2da;</svgmtsi>火锅<svgmtsi class="review">&#xeb0a;</svgmtsi>，<svgmtsi class="review">&#xef32;</svgmtsi><svgmtsi class="review">&#xe5cc;</svgmtsi><svgmtsi class="review">&#xf89b;</svgmtsi>民区里，平添几分市井气。逛<svgmtsi class="review">&#xf122;</svgmtsi><svgmtsi class="review">&#xf39d;</svgmtsi>跑门口蹲着，11：30准时<svgmtsi class="review">&#xef32;</svgmtsi>门，早已守候<svgmtsi class="review">&#xe2da;</svgmtsi>食客迫<svgmtsi class="review">&#xe3ba;</svgmtsi>及待<svgmtsi class="review">&#xe2da;</svgmtsi>往<svgmtsi class="review">&#xeb0a;</svgmtsi>里冲，<svgmtsi class="review">&#xf642;</svgmtsi>为<svgmtsi class="review">&#xedef;</svgmtsi>速占位，<svgmtsi class="review">&#xe3ba;</svgmtsi>然<svgmtsi class="review">&#xf642;</svgmtsi>能拿吃<svgmtsi class="review">&#xe2da;</svgmtsi>号码牌等翻桌了'
    # code_list = re.findall(re.compile(r'<span class="review">&#(.*?);</span>'), string)  之前的span标签改为了svg
    code_list = re.findall(re.compile(r'<svgmtsi class="review">&#(.*?);</svgmtsi>'), string)
    for i in code_list:
        new = "uni" + str(i)[1:]
        # pattern = f'<span class="review">&#{i};</span>'
        pattern = f'<svgmtsi class="review">&#{i};</svgmtsi>'
        string = re.sub(pattern, base_font[new], string)
    print(string)
